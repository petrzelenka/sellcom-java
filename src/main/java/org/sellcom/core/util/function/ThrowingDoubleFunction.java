...
/**
 * Represents a function that accepts a {@code double}-valued argument and produces a result, possibly throwing an exception.
 *
 * @since 1.0
 */
@FunctionalInterface
public interface ThrowingDoubleFunction<R> extends DoubleFunction<R> {
	 ...
	 * @since 1.0
	 */
	R applyThrowing(double argument) throws Exception;

	/**
	 * Returns a {@code DoubleFunction} applying the given function to the argument if this function throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default DoubleFunction<R> fallbackTo(DoubleFunction<R> fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns a {@code DoubleFunction} returning the given value if this function throws an exception.
	 *
	 * @since 1.0
	 */
	 ...
	 * @since 1.0
	 */
	default DoubleFunction<R> orReturn(R value, Consumer<Exception> exceptionConsumer) {
		return argument -> {
			try {
				return applyThrowing(argument);
			} catch (Exception e) {
	...
	/**
	 * Returns a {@code ThrowingDoubleFunction} throwing an exception of the given type if this function throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleFunction<R> orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleFunction<R> orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingDoubleFunction} applying the given function to the argument if this function throws an exception.
	 *
	 * @throws IllegalArgumentException if {@code other} is {@code null}
	 *
	 * @since 1.0
	 */
	default ThrowingDoubleFunction<R> orTryWith(ThrowingDoubleFunction<? extends R> other) {
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleFunction<R> orTryWith(ThrowingDoubleFunction<? extends R> other, Consumer<Exception> exceptionConsumer) {
