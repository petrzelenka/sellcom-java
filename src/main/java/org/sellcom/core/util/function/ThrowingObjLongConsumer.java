...
/**
 * Represents an operation that accepts an {@code object}-valued and a {@code long}-valued argument, and returns no result, possibly throwing an exception.
 *
 * @since 1.0
 */
@FunctionalInterface
public interface ThrowingObjLongConsumer<T> extends ObjLongConsumer<T> {
	 ...
	 * @since 1.0
	 */
	void acceptThrowing(T former, long latter) throws Exception;

	/**
	 * Returns an {@code ObjLongConsumer} performing the given operation on the arguments if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default ObjLongConsumer<T> fallbackTo(ObjLongConsumer<T> fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns a {@code ThrowingObjLongConsumer} throwing an exception of the given type if this operation throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingObjLongConsumer<T> orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingObjLongConsumer<T> orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingObjLongConsumer} performing the given operation on the arguments if this operation throws an exception.
	 *
	 * @throws IllegalArgumentException if {@code other} is {@code null}
	 *
	 * @since 1.0
	 */
	default ThrowingObjLongConsumer<T> orTryWith(ThrowingObjLongConsumer<? super T> other) {
	 ...
	 * @since 1.0
	 */
	default ThrowingObjLongConsumer<T> orTryWith(ThrowingObjLongConsumer<? super T> other, Consumer<Exception> exceptionConsumer) {
