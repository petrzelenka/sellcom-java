...
public interface ThrowingDoubleConsumer extends DoubleConsumer {
	 ...
	 * @since 1.0
	 */
	void acceptThrowing(double argument) throws Exception;

	/**
	 * Returns a {@code DoubleConsumer} performing the given operation on the argument if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default DoubleConsumer fallbackTo(DoubleConsumer fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns a {@code ThrowingDoubleConsumer} throwing an exception of the given type if this operation throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleConsumer orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleConsumer orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingDoubleConsumer} performing the given operation on the argument if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default ThrowingDoubleConsumer orTryWith(ThrowingDoubleConsumer other, Consumer<Exception> exceptionConsumer) {
