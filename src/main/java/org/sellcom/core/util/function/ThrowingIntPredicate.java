...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code int}-valued argument, possibly throwing an exception.
 *
 * @since 1.0
 */
@FunctionalInterface
public interface ThrowingIntPredicate extends IntPredicate {
	 ...
	 * @since 1.0
	 */
	boolean testThrowing(int argument) throws Exception;

	/**
	 * Returns a {@code IntPredicate} evaluating the given predicate on the argument if this predicate throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default IntPredicate fallbackTo(IntPredicate fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns an {@code IntPredicate} returning the given value if this predicate throws an exception.
	 *
	 * @since 1.0
	 */
	 ...
	 * @since 1.0
	 */
	default IntPredicate orReturn(boolean value, Consumer<Exception> exceptionConsumer) {
		return argument -> {
			try {
				return testThrowing(argument);
			} catch (Exception e) {
	...
	/**
	 * Returns a {@code ThrowingIntPredicate} throwing an exception of the given type if this predicate throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingIntPredicate orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingIntPredicate orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingIntPredicate} evaluating the given predicate on the argument if this predicate throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default ThrowingIntPredicate orTryWith(ThrowingIntPredicate other, Consumer<Exception> exceptionConsumer) {
