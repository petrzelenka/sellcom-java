...
/**
 * Represents an operation that accepts a single {@code long}-valued argument and returns no result, possibly throwing an exception.
 *
 * @since 1.0
 */
@FunctionalInterface
public interface ThrowingLongConsumer extends LongConsumer {
	 ...
	 * @since 1.0
	 */
	void acceptThrowing(long argument) throws Exception;

	/**
	 * Returns a {@code LongConsumer} performing the given operation on the argument if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default LongConsumer fallbackTo(LongConsumer fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns a {@code ThrowingLongConsumer} throwing an exception of the given type if this operation throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingLongConsumer orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingLongConsumer orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingLongConsumer} performing the given operation on the argument if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default ThrowingLongConsumer orTryWith(ThrowingLongConsumer other, Consumer<Exception> exceptionConsumer) {
