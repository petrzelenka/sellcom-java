...
/**
 * Represents an operation that accepts an {@code object}-valued and a {@code double}-valued argument, and returns no result, possibly throwing an exception.
 *
 * @since 1.0
 */
@FunctionalInterface
public interface ThrowingObjDoubleConsumer<T> extends ObjDoubleConsumer<T> {
	 ...
	 * @since 1.0
	 */
	void acceptThrowing(T former, double latter) throws Exception;

	/**
	 * Returns an {@code ObjDoubleConsumer} performing the given operation on the arguments if this operation throws an exception.
	 *
	 ...
	 * @since 1.0
	 */
	default ObjDoubleConsumer<T> fallbackTo(ObjDoubleConsumer<T> fallback, Consumer<Exception> exceptionConsumer) {
	...
	/**
	 * Returns a {@code ThrowingObjDoubleConsumer} throwing an exception of the given type if this operation throws an exception.
	 ...
	 * @since 1.0
	 */
	default ThrowingObjDoubleConsumer<T> orThrow(Class<? extends RuntimeException> exceptionClass) {
	 ...
	 * @since 1.0
	 */
	default ThrowingObjDoubleConsumer<T> orThrow(Class<? extends RuntimeException> exceptionClass, String message) {
		Contract.checkArgument(exceptionClass != null, "Exception class must not be null");
	...
	/**
	 * Returns a {@code ThrowingObjDoubleConsumer} performing the given operation on the arguments if this operation throws an exception.
	 *
	 * @throws IllegalArgumentException if {@code other} is {@code null}
	 *
	 * @since 1.0
	 */
	default ThrowingObjDoubleConsumer<T> orTryWith(ThrowingObjDoubleConsumer<? super T> other) {
	 ...
	 * @since 1.0
	 */
	default ThrowingObjDoubleConsumer<T> orTryWith(ThrowingObjDoubleConsumer<? super T> other, Consumer<Exception> exceptionConsumer) {
