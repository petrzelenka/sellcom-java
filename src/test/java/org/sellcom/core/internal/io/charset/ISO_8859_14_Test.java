...
public class ISO_8859_14_Test extends CharsetTest {
	...
	private static char[] LINE_A_CHARS = { '\u00A0', 'Ḃ', 'ḃ', '£', 'Ċ', 'ċ', 'Ḋ', '§', 'Ẁ', '©', 'Ẃ', 'ḋ', 'Ỳ', '\u00AD', '®', 'Ÿ' };
	...
	private static char[] LINE_B_CHARS = { 'Ḟ', 'ḟ', 'Ġ', 'ġ', 'Ṁ', 'ṁ', '¶', 'Ṗ', 'ẁ', 'ṗ', 'ẃ', 'Ṡ', 'ỳ', 'Ẅ', 'ẅ', 'ṡ' };
	...
	private static char[] LINE_C_CHARS = { 'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î', 'Ï' };
	...
	private static char[] LINE_D_CHARS = { 'Ŵ', 'Ñ', 'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ṫ', 'Ø', 'Ù', 'Ú', 'Û', 'Ü', 'Ý', 'Ŷ', 'ß' };
	...
	private static char[] LINE_E_CHARS = { 'à', 'á', 'â', 'ã', 'ä', 'å', 'æ', 'ç', 'è', 'é', 'ê', 'ë', 'ì', 'í', 'î', 'ï' };
	...
	private static char[] LINE_F_CHARS = { 'ŵ', 'ñ', 'ò', 'ó', 'ô', 'õ', 'ö', 'ṫ', 'ø', 'ù', 'ú', 'û', 'ü', 'ý', 'ŷ', 'ÿ' };


	@Test
	public void testDecode() throws CharacterCodingException {
		CharsetDecoder decoder = ISO_8859_14.newDecoder();
	...
	public void testEncode() throws CharacterCodingException {
		CharsetEncoder encoder = ISO_8859_14.newEncoder();
