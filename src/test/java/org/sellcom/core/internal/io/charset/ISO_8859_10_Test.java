...
public class ISO_8859_10_Test extends CharsetTest {
	...
	private static char[] LINE_A_CHARS = { '\u00A0', 'Ą', 'Ē', 'Ģ', 'Ī', 'Ĩ', 'Ķ', '§', 'Ļ', 'Đ', 'Š', 'Ŧ', 'Ž', '\u00AD', 'Ū', 'Ŋ' };
	...
	private static char[] LINE_B_CHARS = { '°', 'ą', 'ē', 'ģ', 'ī', 'ĩ', 'ķ', '·', 'ļ', 'đ', 'š', 'ŧ', 'ž', '―', 'ū', 'ŋ' };
	...
	private static char[] LINE_C_CHARS = { 'Ā', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Į', 'Č', 'É', 'Ę', 'Ë', 'Ė', 'Í', 'Î', 'Ï' };
	...
	private static char[] LINE_D_CHARS = { 'Ð', 'Ņ', 'Ō', 'Ó', 'Ô', 'Õ', 'Ö', 'Ũ', 'Ø', 'Ų', 'Ú', 'Û', 'Ü', 'Ý', 'Þ', 'ß' };
	...
	private static char[] LINE_E_CHARS = { 'ā', 'á', 'â', 'ã', 'ä', 'å', 'æ', 'į', 'č', 'é', 'ę', 'ë', 'ė', 'í', 'î', 'ï' };
	...
	private static char[] LINE_F_CHARS = { 'ð', 'ņ', 'ō', 'ó', 'ô', 'õ', 'ö', 'ũ', 'ø', 'ų', 'ú', 'û', 'ü', 'ý', 'þ', 'ĸ' };


	@Test
	public void testDecode() throws CharacterCodingException {
		CharsetDecoder decoder = ISO_8859_10.newDecoder();
	...
	public void testEncode() throws CharacterCodingException {
		CharsetEncoder encoder = ISO_8859_10.newEncoder();
